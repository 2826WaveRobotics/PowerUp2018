...
int CANTalon_driveDriveLeft3	    = 9;
int CANTalon_driveDriveRight1		= 6;
int CANTalon_driveDriveRight2		= 26;
int CANTalon_driveDriveRight3		= 9;
int CANTalon_elbowElbowRight		= 9;
int CANTalon_elbowElbowLeft			= 9;
int CANTalon_KirbyIntakeRight		= 14;
int CANTalon_KirbyIntakeLeft		= 18;
int CANTalon_elevatorElevatorRight	= 9;
...
int CANTalon_elbowElbowRight		= 2;
int CANTalon_elbowElbowLeft			= 2;
int CANTalon_KirbyIntakeRight		= 2;
int CANTalon_KirbyIntakeLeft		= 2;
int CANTalon_elevatorElevatorRight	= 2;
int CANTalon_elevatorElevatorLeft	= 2;
#endif


#ifdef CompBot
int CANTalon_driveDriveLeft1	    = 17; //6
int CANTalon_driveDriveLeft2	    = 18;
int CANTalon_driveDriveLeft3	    = 19;
int CANTalon_driveDriveRight1		= 20;
int CANTalon_driveDriveRight2		= 21;
int CANTalon_driveDriveRight3		= 22;
int CANTalon_elbowElbowRight		= 23;
int CANTalon_elbowElbowLeft			= 24;
int CANTalon_KirbyIntakeRight		= 25;
int CANTalon_KirbyIntakeLeft		= 26;
int CANTalon_elevatorElevatorRight	= 27;
int CANTalon_elevatorElevatorLeft	= 28;
#endif
...
//    //lw->AddActuator("Drive", "Shifter", driveShifter);
  ...
  //  lw->AddActuator("DrivePID", "RightDriveGroup", drivePIDRightDriveGroup);
   ...
   // lw->AddActuator("DrivePID", "DiffDrive", drivePIDDiffDrive);
    ...
    drivePIDRightEncoder.reset(new frc::Encoder(11, 12, false, frc::Encoder::k4X));
